...
const en = {
  ...
  keys: {
    ...
    'minimize-pane': 'Fold the focused pane to a bar',
    'fold-others': 'Fold the other panes in the column',
    'resize-left': 'Narrow the column',
    'resize-right': 'Widen the column',
    'fit-column': 'Fit the column to the view',
    ...
    'default-terminal': 'Go to the default terminal',
...
const ko: Catalog = {
  firstRun: {
    ...
    zoomPane: 'pane 최대화',
    foldPane: 'pane 접기',
    foldOthers: '다른 pane 접기',
    closePane: 'pane 닫기',
    newSession: '새 세션',
    saveAsSession: '세션으로 저장',
    newTerminal: '새 터미널',
    saveLayout: '현재 배치 저장',
  ...
  settings: {
    ...
    focusBorderDesc: '흰색, 팔레트 강조색, 직접 지정 중에서 고릅니다',
    focusBorderWhite: '흰색',
    focusBorderPalette: '팔레트 강조색',
    focusBorderCustom: '직접 지정',
    focusBorderColorTitle: '#7a9bbf 처럼 여섯 자리 색 코드',
    localeLabel: '언어',
  ...
  keys: {
    ...
    'minimize-pane': '포커스한 pane 한 줄로 접기',
    'fold-others': '컬럼의 다른 pane 접기',
    'resize-left': '컬럼 좁히기',
    'resize-right': '컬럼 넓히기',
    'fit-column': '컬럼 너비 맞추기',
